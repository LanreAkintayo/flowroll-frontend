...
export function TransactionModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md bg-white dark:bg-[#0A0A0A] border-slate-200 dark:border-slate-800 p-0 overflow-hidden gap-0 rounded-[1.5rem] shadow-2xl">
        ...
        <div className="p-6 sm:p-8">
          ...
          {status === "review" && (
            <div className="flex flex-col animate-in fade-in zoom-in-95 duration-300">
              ...
              <div className="bg-slate-50 dark:bg-[#0f0f0f] border border-slate-200 dark:border-slate-800/80 rounded-2xl p-5 mb-6">
