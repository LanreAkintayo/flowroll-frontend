...
export function OmnichainBridge() {
  ...
  const currentChainName = isTestnet ? TESTNET_CONFIG.pretty_name : APPCHAIN_CONFIG.pretty_name
          ...
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
              ...
              <div className="flex items-center gap-2 flex-wrap min-w-0">
                <h2 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white uppercase tracking-widest truncate">Flowroll Bridge</h2>
          ...
          <div className="flex flex-col relative mb-6 sm:mb-8">
            <div className="bg-slate-50 dark:bg-[#0b1120] border border-slate-200 dark:border-slate-800/80 rounded-[1.25rem] sm:rounded-2xl p-4 sm:p-5 pb-6 sm:pb-8 relative">
              <div className="flex justify-between items-center mb-3 sm:mb-4 gap-2">
                <span className="text-[9px] sm:text-[10px] font-bold text-slate-500 uppercase tracking-widest shrink-0">From</span>
              ...
              <div className="flex items-center justify-between gap-2 sm:gap-4 min-w-0 w-full">
                <input
                  ...
                  placeholder="0.00"
                />
                <span className="text-lg sm:text-xl font-medium text-slate-600 shrink-0">USDC</span>
              </div>
            ...
            <div className="bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800/80 rounded-b-[1.25rem] sm:rounded-b-2xl p-4 sm:p-5 pt-6 sm:pt-8 -mt-4 relative">
              <div className="flex justify-between items-center mb-3 sm:mb-4">
                <span className="text-[9px] sm:text-[10px] font-bold text-slate-500 uppercase tracking-widest">To</span>
              </div>
                ...
                <PopoverTrigger asChild>
                  ...
                  >
                    <div className="flex items-center gap-2.5 sm:gap-3 truncate">
                      <span className="text-xl sm:text-2xl shrink-0">{targetChain.icon}</span>
