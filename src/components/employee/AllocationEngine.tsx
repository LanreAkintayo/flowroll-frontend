            ...
            <div className="bg-white dark:bg-[#0A0A0A] rounded-[1.5rem] sm:rounded-[2rem] border border-slate-200 dark:border-slate-800/80 relative overflow-hidden flex flex-col h-full shadow-xs">
                ...
                <div className="px-5 sm:px-6 lg:px-8 pt-5 sm:pt-6 lg:pt-8 flex items-center justify-between relative z-10">
                    <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                        ...
                        <h2 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white uppercase tracking-widest truncate">Allocation Engine</h2>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center pt-6 pb-6 px-5 sm:pt-8 sm:pb-8 sm:px-8 border-b border-slate-100 dark:border-slate-800/50 relative z-10">
                    <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.3em] text-slate-500 mb-1 sm:mb-2 text-center">You are claiming</p>
                    ...
                    <div className="relative group flex items-center justify-center w-full my-2 sm:my-3">
                        <div className="flex items-baseline max-w-full">
                            <span className="text-3xl sm:text-5xl lg:text-6xl font-light text-slate-300 dark:text-slate-700 transition-colors group-focus-within:text-slate-900 dark:group-focus-within:text-white mr-1 sm:mr-2 shrink-0">
                                $
                            </span>
                            <input
                                type="text"
                                ...
                                className="bg-transparent text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 dark:text-white text-left outline-none w-[140px] sm:w-[220px] tabular-nums tracking-tighter placeholder:text-slate-200 dark:placeholder:text-slate-800 transition-all min-w-0"
                                placeholder="0.00"
                            />
                        </div>
                    </div>
                    ...
                    >
                        <span className="truncate">Balance: {formatUSDC(Number(formattedMax))} USDC</span>
                        <span className="text-[8px] sm:text-[9px] uppercase tracking-wider bg-slate-200 dark:bg-slate-800 px-1.5 py-0.5 rounded text-slate-700 dark:text-slate-300 shrink-0">Max</span>
                    </button>
                </div>
                ...
                <div className="p-5 sm:p-6 lg:p-8 flex flex-col relative z-10 flex-1">
                    <div className="mb-6 sm:mb-8">
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
                            <h3 className="text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-widest">Routing Split</h3>
                            ...
                            <div className="flex gap-1 bg-slate-100 dark:bg-slate-900/80 p-1 rounded-xl sm:rounded-xl border border-slate-200 dark:border-slate-800 w-full sm:w-auto">
                                {[0, 25, 50, 75, 100].map((pct) => (
                                    <button
                                        ...
                                        className={`flex-1 sm:flex-none text-[10px] font-bold px-2 sm:px-3 py-1.5 sm:py-1.5 rounded-lg transition-all ${savePct === pct
                        ...
                        <div className="flex flex-col sm:flex-row w-full sm:items-stretch bg-white dark:bg-[#0A0A0A] border border-slate-200 dark:border-slate-800 rounded-[1rem] sm:rounded-[1.25rem] overflow-hidden transition-all">
                            ...
                            <div className="flex-1 p-4 sm:p-5 bg-slate-50 dark:bg-[#0f0f0f] transition-all min-w-0">
                                ...
                                <div className="flex items-baseline gap-1 sm:gap-1.5 min-w-0 w-full">
                                    ...
                                    <span className="text-xs sm:text-sm font-medium text-slate-500 shrink-0">USDC</span>
                                </div>
                            </div>
                            ...
                            <div className={`flex-1 p-4 sm:p-5 transition-all duration-500 min-w-0 ${savePct > 0
                                    ? 'bg-emerald-50/50 dark:bg-emerald-500/10'
                                    : 'bg-white dark:bg-[#0A0A0A]'
                                }`}>
                                <p className={`text-[9px] sm:text-[10px] font-bold uppercase tracking-widest flex items-center gap-1.5 mb-1.5 sm:mb-2 truncate ${savePct > 0 ? 'text-slate-600 dark:text-slate-400' : 'text-slate-500'}`}>
                                    <TrendingUp className="w-3 h-3 shrink-0" /> Auto-Save
                                </p>
                                <div className="flex items-baseline gap-1 sm:gap-1.5 min-w-0 w-full">
                                    <p className={`text-xl sm:text-2xl font-bold tracking-tight tabular-nums leading-none truncate ${savePct > 0 ? 'text-slate-700 dark:text-white' : 'text-slate-600'}`}>
                                ...
                                <div className="bg-slate-50 dark:bg-[#0f0f0f] border border-slate-200 dark:border-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-5 mb-6 sm:mb-8">
                                    <div className="flex gap-2.5 sm:gap-3 mb-4 sm:mb-5">
                                        ...
                                        <div className="min-w-0">
                                            <h4 className="text-xs sm:text-sm font-medium text-slate-900 dark:text-white mb-0.5 truncate">Flowroll Vault Enabled</h4>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 sm:gap-4">
                                        <div className="min-w-0">
                                            <label className="text-[9px] sm:text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5 sm:mb-2 block truncate">Duration</label>
                                            <Input
                                                type="number"
                                                value={durationValue}
                                        ...
                                        <div className="min-w-0">
                                            <label className="text-[9px] sm:text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5 sm:mb-2 block truncate">Time Unit</label>
                    ...
                    <Button
                        ...
                        className={`w-full h-12 sm:h-14 mt-auto rounded-xl sm:rounded-2xl font-medium text-xs sm:text-sm lg:text-base transition-all disabled:opacity-50 disabled:cursor-not-allowed ${savePct > 0
                    ...
                    >
                        <span className="truncate">{savePct > 0 ? `Execute: Claim & Route (${savePct}%)` : "Execute: Liquid Claim"}</span>
