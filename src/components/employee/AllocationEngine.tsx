  ...
  return (
    <div className="lg:col-span-7 flex flex-col h-full">
      <div className="bg-white dark:bg-[#0A0A0A] rounded-[2rem] border border-slate-200 dark:border-slate-800/80 shadow-sm relative overflow-hidden flex flex-col h-full">
        ...
        {/* --- MASSIVE HERO INPUT --- */}
        <div className="flex flex-col items-center justify-center pt-10 pb-12 px-8 border-b border-slate-100 dark:border-slate-800/50 relative z-10">
          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400 mb-2">You are claiming</p>
          ...
          <div className="relative group flex items-center justify-center w-full">
            ...
            <input
              ...
              className="bg-transparent text-6xl sm:text-7xl font-black text-slate-900 dark:text-white text-center outline-none w-full max-w-[300px] tabular-nums tracking-tighter placeholder:text-slate-200 dark:placeholder:text-slate-800 transition-all"
              placeholder="0.00"
            />
          </div>
        ...
        <div className="p-8 flex-1 flex flex-col justify-between relative z-10">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4">
               ...
               {/* Vault Side */}
               <div className={`flex-1 border rounded-2xl p-4 transition-all duration-500 ${
                  savePct > 0 
                    ? 'bg-violet-50/50 dark:bg-violet-500/10 border-violet-200 dark:border-violet-500/20' 
                    : 'bg-slate-50 dark:bg-[#0f0f0f] border-slate-200 dark:border-slate-800/80'
               }`}>
                  <p className={`text-[10px] font-bold uppercase tracking-widest flex items-center gap-1.5 mb-2 ${
                    savePct > 0 ? 'text-violet-600 dark:text-violet-400' : 'text-slate-400'
                  }`}>
                    <TrendingUp className="w-3 h-3" /> Auto-Save
                  </p>
                  <p className={`text-2xl font-black tabular-nums tracking-tight ${
                    savePct > 0 ? 'text-violet-700 dark:text-white' : 'text-slate-400'
                  }`}>
