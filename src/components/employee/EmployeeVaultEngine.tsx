  ...
  useEffect(() => {
    ...
    const fetchMetrics = async () => {
      try {
        ...
        console.error("Agent metric sync failed:", error);
      }
    };
    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
          <div className="hidden lg:flex w-[280px] shrink-0 bg-slate-50/50 dark:bg-[#0b1120]/50 border-r border-slate-200 dark:border-slate-800 flex-col p-6 overflow-y-auto no-scrollbar z-10">
              ...
              {activeView === "ledger" && (
                ...
                >
                  <div className="max-w-3xl mx-auto px-4 sm:px-0">
                    ...
                    <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mb-8 sm:mb-10">
