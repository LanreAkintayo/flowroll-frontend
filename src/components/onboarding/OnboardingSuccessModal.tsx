                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full">
                                ...
                                <Button
                                    asChild
                                    className="group relative w-full sm:w-1/2 h-14 sm:h-16 rounded-xl sm:rounded-2xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold transition-all duration-300 hover:bg-slate-800 dark:hover:bg-slate-100 hover:-translate-y-1 cursor-pointer border-none shadow-none"
                                >
                                    <Link 
                                        href="/employer" 
                                        onClick={() => setRole("employer")}
                                        className="flex items-center w-full min-w-0 pl-2.5 sm:pl-3 pr-3 sm:pr-4"
                                    >
                                ...
                                <Button
                                    asChild
                                    variant="outline"
                                    className="group relative w-full sm:w-1/2 h-14 sm:h-16 rounded-xl sm:rounded-2xl bg-transparent border-slate-200 dark:border-slate-800 font-bold transition-all duration-300 hover:bg-slate-50 dark:hover:bg-[#0d1117] hover:-translate-y-1 cursor-pointer shadow-none"
                                >
                                    <Link 
                                        href="/employee" 
