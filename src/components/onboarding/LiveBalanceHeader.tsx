            ...
            <div className="inline-flex items-center justify-between bg-white dark:bg-[#0a0a0a] border border-slate-200 dark:border-slate-800/80 rounded-[2.5rem] sm:rounded-full p-2 shadow-sm min-w-max">
                ...
                <div className="flex items-center gap-4 px-5 sm:px-6 py-2">
                    <div className={`p-2.5 rounded-full transition-colors duration-500 ${
                        step1Complete ? 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-500' : 'bg-slate-50 dark:bg-slate-900 text-slate-400'
                    }`}>
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <span className="text-xl sm:text-2xl font-black tracking-tighter text-slate-900 dark:text-white leading-none">
                            {isLoading ? '...' : formatMoney(balances.gas, 18)}
                        </span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4 px-5 sm:px-6 py-2">
                    <div className={`p-2.5 rounded-full transition-colors duration-500 ${
                        step2Complete ? 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-500' : 'bg-slate-50 dark:bg-slate-900 text-slate-400'
                    }`}>
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <span className="text-xl sm:text-2xl font-black tracking-tighter text-slate-900 dark:text-white leading-none">
                            {isLoading ? '...' : formatMoney(balances.init, 18)}
                        </span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4 px-5 sm:px-6 py-2 pr-6 sm:pr-8">
                    <div className={`p-2.5 rounded-full transition-colors duration-500 ${
                        allSetupComplete ? 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-500' : 'bg-slate-50 dark:bg-slate-900 text-slate-400'
                    }`}>
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <span className="text-xl sm:text-2xl font-black tracking-tighter text-slate-900 dark:text-white leading-none">
                            {isLoading ? '...' : formatMoney(balances.usdc, 6)}
                        </span>
                    </div>
                </div>
