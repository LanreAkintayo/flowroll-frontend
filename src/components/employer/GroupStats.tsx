...
import { useGroupDetails, useTotalPayroll } from "@/hooks/payroll/usePayrollQueries";
    ...
    return (
      <div className="w-full bg-white dark:bg-[#0a0c10] rounded-[1.5rem] sm:rounded-[2rem] border border-slate-100 dark:border-slate-800/80 shadow-xs p-6 sm:p-8 mb-8 flex items-center justify-center h-[120px] sm:h-[160px]">
        <div className="flex items-center gap-2 sm:gap-3 text-slate-400 dark:text-slate-600 animate-pulse">
          ...
          <span className="text-xs sm:text-sm font-medium">Syncing on-chain data...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-px">
        ...
        <div className="bg-white dark:bg-[#0a0c10] p-4 sm:p-6 xl:p-8 transition-colors hover:bg-slate-50/80 dark:hover:bg-[#0d1117] relative flex flex-col justify-between">
          <div className="flex items-center gap-1.5 sm:gap-2.5 text-slate-500 mb-2 sm:mb-4">
            <Wallet className={`w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 ${isInsufficient ? "text-amber-500" : "text-teal-500"}`} />
            <span className="text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-widest truncate">Wallet Balance</span>
          </div>

          <div className="group/num relative inline-flex items-baseline cursor-help w-fit">
            <span className={`text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-montserrat font-bold tracking-tight border-b-2 border-dashed ${isInsufficient ? "text-amber-600 dark:text-amber-500 border-amber-200 dark:border-amber-900" : "text-slate-900 dark:text-white border-slate-200 dark:border-slate-800 group-hover/num:border-slate-400 transition-colors"}`}>
              {balance.compact}
            </span>
            <span className={`${isInsufficient ? "text-amber-400" : "text-slate-600 dark:text-slate-500"} text-[10px] sm:text-sm font-medium ml-1`}>USDC</span>
        ...
        <div className="bg-white dark:bg-[#0a0c10] p-4 sm:p-6 xl:p-8 transition-colors hover:bg-slate-50/80 dark:hover:bg-[#0d1117] flex flex-col justify-between">
          <div className="flex items-center gap-1.5 sm:gap-2.5 text-slate-500 mb-2 sm:mb-4">
            ...
            <span className="text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-widest truncate">Total Payroll</span>
          </div>
          <div className="group/num relative inline-flex items-baseline cursor-help w-fit">
            ...
            <span className="text-slate-600 dark:text-slate-500 text-[10px] sm:text-sm font-medium ml-1">USDC</span>
            <div className="absolute top-full left-0 sm:left-0 -translate-x-1/4 sm:translate-x-0 mt-2 hidden group-hover/num:block z-50">
              <div className="bg-slate-900 dark:bg-slate-800 text-white text-[10px] sm:text-xs font-mono font-medium py-1.5 px-2.5 rounded-lg shadow-xl whitespace-nowrap">
                {payroll.exact} USDC
              </div>
        ...
        <div className="bg-white dark:bg-[#0a0c10] p-4 sm:p-6 xl:p-8 transition-colors hover:bg-slate-50/80 dark:hover:bg-[#0d1117] flex flex-col justify-between">
          <div className="flex items-center gap-1.5 sm:gap-2.5 text-slate-500 mb-2 sm:mb-4">
            ...
            <span className="text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-widest truncate">Yield Earned</span>
          </div>
          <div className="group/num relative inline-flex items-baseline cursor-help w-fit">
            <span className={`text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-montserrat font-bold tracking-tight border-b-2 border-dashed transition-colors ${isLoss ? "text-slate-800 dark:text-slate-400 border-slate-200 dark:border-slate-800 group-hover/num:border-slate-400 dark:group-hover/num:border-slate-600" : "text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-900 group-hover/num:border-emerald-400"}`}>
              {isLoss ? "-" : "+"}{yieldAmount.compact}
            </span>
            <span className={`text-[10px] sm:text-sm font-medium ml-1 ${isLoss ? "text-slate-600 dark:text-slate-500" : "text-emerald-600 dark:text-emerald-400/70"}`}>USDC</span>
            <div className="absolute top-full left-0 sm:left-0 -translate-x-1/4 sm:translate-x-0 mt-2 hidden group-hover/num:block z-50">
              <div className="bg-slate-900 dark:bg-slate-800 text-white text-[10px] sm:text-xs font-mono font-medium py-1.5 px-2.5 rounded-lg shadow-xl whitespace-nowrap">
        ...
        <div className="bg-white dark:bg-[#0a0c10] p-4 sm:p-6 xl:p-8 transition-colors hover:bg-slate-50/80 dark:hover:bg-[#0d1117] flex flex-col justify-between">
          <div className="flex items-center gap-1.5 sm:gap-2.5 text-slate-500 mb-2 sm:mb-4">
            <Clock className={`w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 ${isPaydayReached ? "text-amber-500" : "text-blue-500"}`} />
            <span className="text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-widest truncate">Time to Payday</span>
          </div>
        ...
        <div className="bg-white dark:bg-[#0a0c10] p-4 sm:p-6 xl:p-8 transition-colors hover:bg-slate-50/80 dark:hover:bg-[#0d1117] flex flex-col justify-between">
          <div className="flex items-center gap-1.5 sm:gap-2.5 text-slate-500 mb-2 sm:mb-4">
            ...
            <span className="text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-widest truncate">Active Epoch</span>
          </div>
          <div className="flex items-baseline gap-1 sm:gap-1.5">
            <span className="text-slate-600 dark:text-slate-500 text-sm sm:text-xl font-medium">#</span>
        ...
        <div className={`p-4 sm:p-6 xl:p-8 transition-colors flex flex-col justify-between relative overflow-hidden h-full ${
          isEngineActive
          ...
          <div className="flex flex-col flex-1">
            <div className="flex items-center gap-1.5 sm:gap-2 text-slate-500 mb-2 sm:mb-4 relative z-10 min-w-0">
              {isEngineActive ? (
                <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 text-emerald-500" />
              ) : isPaydayReached ? (
              ...
              <span className="text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-widest truncate">Yield Engine</span>
            </div>

            <div className="relative z-10 flex items-center gap-1.5 sm:gap-2.5 mt-0 sm:mt-1 min-w-0">
              {isPaydayReached ? (
                <span className="text-amber-700 dark:text-amber-500 font-semibold tracking-wide text-[10px] sm:text-[11px] lg:text-sm truncate">Payday Reached</span>
              ) : isEngineActive ? (
                <span className="text-emerald-700 dark:text-emerald-500 font-semibold tracking-wide text-[10px] sm:text-[11px] lg:text-sm truncate">Active</span>
              ) : isEngineOffline ? (
                <span className="text-rose-700 dark:text-rose-500 font-semibold tracking-wide text-[10px] sm:text-[11px] lg:text-sm truncate">Agent Offline</span>
              ) : (
                <>
                  ...
                  <span className="text-slate-600 dark:text-slate-400 tracking-wide text-[10px] sm:text-[11px] lg:text-sm truncate">Idle</span>
                </>
              )}
            </div>
          </div>
          ...
          {/* Terminal Action */}
          {onToggleTerminal && cycleData?.isActive &&  (
            <Button
            ...
            >
              ...
              <ChevronDown className={`w-3 h-3 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4 shrink-0 transition-transform duration-300 ${showTerminal ? "rotate-180" : ""}`} />
            </Button>
          )}

          {/* Ambient Glow Effects */}
          {isEngineActive && <div className="absolute -bottom-10 -right-10 w-24 h-24 sm:w-40 sm:h-40 bg-emerald-400/10 dark:bg-emerald-500/10 rounded-full blur-2xl sm:blur-3xl pointer-events-none" />}
          {isPaydayReached && <div className="absolute -bottom-10 -right-10 w-24 h-24 sm:w-40 sm:h-40 bg-amber-400/10 dark:bg-amber-500/10 rounded-full blur-2xl sm:blur-3xl pointer-events-none" />}
          {isEngineOffline && <div className="absolute -bottom-10 -right-10 w-24 h-24 sm:w-40 sm:h-40 bg-rose-400/10 dark:bg-rose-500/10 rounded-full blur-2xl sm:blur-3xl pointer-events-none" />}
        </div>
...
//   // Agent and Yield synchronization
//   const { data: yieldData } = useLiveYield(address, group?.activeCycleId);
//   const { data: isAgentRunning } = useAgentStatus();

//   // Active Countdown Lifecycle
//   const [timeRemaining, setTimeRemaining] = useState(0);
//   const payDay = cycleData?.payDay ? Number(cycleData.payDay) : 0;
...
//   if (loadingGroup || loadingPayroll || loadingBalance || loadingCycle) {
//     return (
//       <div className="w-full bg-white dark:bg-[#0a0c10] rounded-[2rem] border border-slate-100 dark:border-slate-800/80 shadow-xs p-8 mb-8 flex items-center justify-center h-[160px]">
//         <div className="flex items-center gap-3 text-slate-400 dark:text-slate-600 animate-pulse">
...
//   return (
//     <div className="w-full bg-slate-100 dark:bg-slate-800/50 rounded-[2rem] border border-slate-200/60 dark:border-slate-700/50 shadow-[0_2px_10px_rgb(0,0,0,0.02)] mb-8 overflow-hidden">
      
//       {/* 6-Grid Configuration */}
//       <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-px">

//         {/* 1. Wallet Balance */}
//         <div className="bg-white dark:bg-[#0a0c10] p-6 xl:p-8 transition-colors hover:bg-slate-50/80 dark:hover:bg-[#0d1117] relative">
...
//             <span className={`text-3xl xl:text-4xl font-montserrat font-bold tracking-tight border-b-2 border-dashed ${isInsufficient ? "text-amber-600 dark:text-amber-500 border-amber-200 dark:border-amber-900" : "text-slate-900 dark:text-white border-slate-200 dark:border-slate-800 group-hover/num:border-slate-400 transition-colors"}`}>
//               {balance.compact}
//             </span>
//             <span className={`${isInsufficient ? "text-amber-400" : "text-slate-600 dark:text-slate-500"} text-sm font-medium ml-1`}>USDC</span>
//             <div className="absolute top-full left-0 mt-2 hidden group-hover/num:block z-50">
//               <div className="bg-slate-900 dark:bg-slate-800 text-white text-xs font-mono font-medium py-1.5 px-2.5 rounded-lg shadow-xl whitespace-nowrap">
//                 {balance.exact} USDC
//               </div>
//             </div>
//           </div>
...
//                 <div className="bg-amber-100 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 text-amber-900 dark:text-amber-400 text-xs font-semibold py-2 px-3 rounded-lg shadow-xl">
//                   Insufficient funds for next cycle
//                 </div>
//               </div>
//             </div>
...
//         {/* 2. Total Payroll */}
//         <div className="bg-white dark:bg-[#0a0c10] p-6 xl:p-8 transition-colors hover:bg-slate-50/80 dark:hover:bg-[#0d1117]">
//           <div className="flex items-center gap-2.5 text-slate-500 mb-4">
//             <DollarSign className="w-4 h-4 text-violet-500 dark:text-violet-400" />
//             <span className="text-xs font-bold uppercase tracking-widest whitespace-nowrap">Total Payroll</span>
//           </div>
//           <div className="group/num relative inline-flex items-baseline cursor-help">
//             <span className="text-3xl xl:text-4xl font-montserrat font-bold text-slate-900 dark:text-white tracking-tight border-b-2 border-dashed border-slate-200 dark:border-slate-800 group-hover/num:border-slate-400 transition-colors">
//               {payroll.compact}
//             </span>
//             <span className="text-slate-600 dark:text-slate-500 text-sm font-medium ml-1">USDC</span>
//             <div className="absolute top-full left-0 mt-2 hidden group-hover/num:block z-50">
//               <div className="bg-slate-900 dark:bg-slate-800 text-white text-xs font-mono font-medium py-1.5 px-2.5 rounded-lg shadow-xl whitespace-nowrap">
//                 {payroll.exact} USDC
//               </div>
...
//           <div className="flex items-center gap-2.5 text-slate-500 mb-4">
//             {isLoss ? (
//               <TrendingDown className="w-4 h-4 text-slate-600 dark:text-slate-500" />
//             ) : (
...
//           </div>
//           <div className="group/num relative inline-flex items-baseline cursor-help">
//             <span className={`text-3xl xl:text-4xl font-montserrat font-bold tracking-tight border-b-2 border-dashed transition-colors ${isLoss ? "text-slate-800 dark:text-slate-400 border-slate-200 dark:border-slate-800 group-hover/num:border-slate-400 dark:group-hover/num:border-slate-600" : "text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-900 group-hover/num:border-emerald-400"}`}>
//               {isLoss ? "-" : "+"}{yieldAmount.compact}
//             </span>
//             <span className={`text-sm font-medium ml-1 ${isLoss ? "text-slate-600 dark:text-slate-500" : "text-emerald-600 dark:text-emerald-400/70"}`}>USDC</span>
//             <div className="absolute top-full left-0 mt-2 hidden group-hover/num:block z-50">
//               <div className="bg-slate-900 dark:bg-slate-800 text-white text-xs font-mono font-medium py-1.5 px-2.5 rounded-lg shadow-xl whitespace-nowrap">
//                 {isLoss ? "-" : "+"}{yieldAmount.exact} USDC
//               </div>
...
//           </div>
//           <div className="flex items-baseline gap-2">
//             <span className="text-3xl xl:text-4xl font-montserrat font-bold tracking-tight text-slate-900 dark:text-white">
//               {duration}
//             </span>
//           </div>
//         </div>
...
//             <span className="text-slate-600 dark:text-slate-500 text-xl font-medium">#</span>
//             <span className="text-3xl xl:text-4xl font-montserrat font-bold text-slate-900 dark:text-white tracking-tight">
//               {group?.activeCycleId?.toString() || "0"}
//             </span>
//           </div>
//         </div>
...
//         {/* 6. Yield Engine State Block */}
//         <div className={`p-5 sm:p-6 xl:p-8 transition-colors flex flex-col justify-between relative overflow-hidden h-full ${
//           isEngineActive
//             ? "bg-emerald-50/60 dark:bg-emerald-500/5 hover:bg-emerald-50 dark:hover:bg-emerald-500/10"
//             : isPaydayReached
//             ? "bg-amber-50/60 dark:bg-amber-500/5 hover:bg-amber-50 dark:hover:bg-amber-500/10"
...
//               {isPaydayReached ? (
//                 <span className="text-amber-700 dark:text-amber-500 font-semibold tracking-wide text-[11px] sm:text-sm truncate">Payday Reached</span>
//               ) : isEngineActive ? (
//                 <span className="text-emerald-700 dark:text-emerald-500 font-semibold tracking-wide text-[11px] sm:text-sm truncate">Active</span>
//               ) : isEngineOffline ? (
//                 <span className="text-rose-700 dark:text-rose-500 font-semibold tracking-wide text-[11px] sm:text-sm truncate">Agent Offline</span>
//               ) : (
//                 <>
//                   <div className="relative flex h-2.5 w-2.5 sm:h-3 sm:w-3 shrink-0">
//                     <span className="relative inline-flex rounded-full h-full w-full bg-slate-400 dark:bg-slate-600" />
//                   </div>
//                   <span className="text-slate-600 dark:text-slate-400 tracking-wide text-[11px] sm:text-sm truncate">Idle</span>
//                 </>
//               )}
//             </div>
//           </div>
...
//             <Button
//               onClick={onToggleTerminal}
//               className={`relative z-10 mt-5 sm:mt-6 flex items-center justify-between w-full px-3 py-2 sm:px-4 sm:py-2.5 text-[10px] sm:text-xs font-semibold rounded-xl transition-all border ${
//                 isEngineActive
//                   ? "bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border-emerald-500/20 hover:bg-emerald-500/20"
//                   : isPaydayReached
//                   ? "bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-500/20 hover:bg-amber-500/20"
...
//           {/* Ambient Glow Effects */}
//           {isEngineActive && <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-emerald-400/10 dark:bg-emerald-500/10 rounded-full blur-3xl pointer-events-none" />}
//           {isPaydayReached && <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-amber-400/10 dark:bg-amber-500/10 rounded-full blur-3xl pointer-events-none" />}
//           {isEngineOffline && <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-rose-400/10 dark:bg-rose-500/10 rounded-full blur-3xl pointer-events-none" />}
//         </div>
