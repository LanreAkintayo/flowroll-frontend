...
//           <motion.div
//             variants={itemVariants}
//             className="lg:col-span-4 bg-white dark:bg-[#0a0c10] rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between group hover:border-violet-200 dark:hover:border-violet-500/30 transition-colors"
//           >
//             <div className="flex justify-between items-start">
//               <div className="bg-slate-50 dark:bg-slate-900 p-3 rounded-2xl border border-slate-100 dark:border-slate-800 group-hover:scale-110 transition-transform">
//                 <Layers className="w-6 h-6 text-slate-900 dark:text-white" />
//               </div>
//               <div className="flex items-center gap-1.5 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
//                 <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
//                 Earning
//               </div>
//             </div>
...
//             <div>
//               <p className="text-slate-500 dark:text-slate-400 text-sm font-medium uppercase tracking-[0.2em] mb-2">
//                 Allocated Capital
//               </p>
...
//             variants={itemVariants}
//             onClick={() => setIsYieldModalOpen(true)}
//             className="lg:col-span-3 cursor-pointer group relative overflow-hidden rounded-[2.5rem] p-8 transition-all duration-500 hover:-translate-y-2 bg-white dark:bg-[#0a0c10] border border-slate-200 dark:border-slate-800 shadow-sm"
//           >
//             <div className="flex flex-col h-full justify-between relative z-20">
//               <div className="mb-8">
//                 <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-900 shadow-sm border border-emerald-50 dark:border-emerald-500/20 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
...
//                     Explore Mechanics
//                   </span>
//                   <div className="w-8 h-8 rounded-full bg-emerald-100/50 dark:bg-emerald-500/10 flex items-center justify-center group-hover:translate-x-2 transition-transform duration-300">
