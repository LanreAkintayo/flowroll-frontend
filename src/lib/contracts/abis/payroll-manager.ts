export const PAYROLL_MANAGER_ABI = [
  ...
  },
  {
    ...
    outputs: [{ name: "groupId", type: "uint256", internalType: "uint256" }],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [{ name: "_dispatcher", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    outputs: [{ name: "cycleId", type: "uint256", internalType: "uint256" }],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
